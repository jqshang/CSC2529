...
**Download dataset.** Please checkout [Experiments/data_loading.ipynb](../Experiments/data_loading.ipynb), or download the FiveK dataset from https://data.csail.mit.edu/graphics/fivek/ to `data/fivek_dataset`
```bash
