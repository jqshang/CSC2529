...
from rawdiffusion.models.controlnet import RAWControlNet, RAWDiffusionWithControlNet
...
class RAWDiffusionModule(LightningModule):
    ...
    def __init__(self, experiment_folder, **hparams) -> None:
        ...
        self.model = RAWDiffusionWithControlNet(backbone,
                                                controlnet,
    ...
    def preprocess_guidance(self, guidance_data, camera_id=None):
        guidance_input = {}
